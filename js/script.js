let tickerText =
  ...
  "✶  ketik REG ARISAN ke 1211  ✶  tarif Rp.2000/Sms. untuk berhenti ketik UNREG ARISAN ke 1211  ✶";

let tickerText2 =
  // "SOUNDS BY SSPEL   ✶   SOUNDS BY SSPEL   ✶   SOUNDS BY SSPEL   ✶   SOUNDS BY SSPEL   ✶   SOUNDS BY SSPEL   ✶   SOUNDS BY SSPEL";
  "✶  alamat praktek: Jalan Pender Timur, No. 147 / call center: (021) 173 6116  ✶";
...
function draw() {
  ...
  fill("#fdf87c"); // Set the color to white
  // stroke("#df397f"); // Set stroke color
  stroke("#2aa1fc"); // Set stroke color
  textSize(50);
  strokeWeight(15); // Set stroke weight
